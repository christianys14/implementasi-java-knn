...
public class FormJamak extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelHasilPrediksi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "No", "NIM", "Nama", "JK", "IPS 1", "IPS 2", "IPS 3", "IPS 4", "IPS 5", "IPS 6", "SKS", "KET", "Prediksi"
            }
        ) {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(comboJumlahK, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(comboJumlahK, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addComponent(jLabel3))
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(tombolProses)
                .addComponent(tombolBersih))
    ...
    private void tombolProsesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolProsesActionPerformed
        if (comboJumlahK.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(this, "Belum Memilih Jumlah K", "Informasi Kesalahan Proses Prediksi", JOptionPane.WARNING_MESSAGE);
            ...
            double[][] nilaiTraining = nilaiDefaultTraining(jTrainingBaris),
                    ...
                    nilaiKuadrat = nilaiPerhitunganKuadrat(jTrainingBaris, jTestingBaris, nilaiTraining, nilaiTesting),
                    hasilTempS;
            ...
            tabelHasilPrediksi.setModel(new DefaultTableModel(
                    nilaiTestingKumpul,
                    new String[]{
                        "No.", "NIM", "Nama", "JK", "IPS1", "IPS2", "IPS3", "IPS4", "IPS5", "IPS6", "SKS", "KET", "PREDIKSI"
                    }));
            ...
            double rata1 = Double.parseDouble(df.format(jum / Double.parseDouble(String.valueOf(jTestingBaris)))) * 100;
            ...
            info += "Waktu = " + w3 + " Detik";
            JOptionPane.showMessageDialog(this, info, "Informasi Hasil Prediksi", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    double[][] nilaiPerhitunganKuadrat(int pJTraining, int pJTesting, double[][] pTraining, double[][] pTesting) {
        ...
        for (int i = 0; i < pJTraining; i++) {
            for (int j = 0; j < pJTesting; j++) {
                double ips1 = Math.abs(pTraining[i][0] - pTesting[j][0]),
                        ...
                        + Math.pow(ips3, 2) + Math.pow(ips4, 2)
                        + Math.pow(ips5, 2) + Math.pow(ips6, 2)
                        + Math.pow(totalSKS, 2),
    ...
    double[][][] sortingNilaiTraining(double nilaiTrain[][], double hasilKuadrat[][], int indexTesting) {
